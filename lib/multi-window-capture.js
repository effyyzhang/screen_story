...
class MultiWindowCapture {
   ...
   * @param {Object} options - {interval: 5000, duration: 60000, captureActive: true}
   */
  static async monitorTaskWindows(taskDescription, outputDir, options = {}) {
    ...
    // Predict which apps to monitor
    const appsToMonitor = this.predictAppsForTask(taskDescription);
